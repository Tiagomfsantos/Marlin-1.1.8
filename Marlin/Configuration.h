...
#define STRING_CONFIG_H_AUTHOR "Tiago Santos, Anet A8 config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Hot and"
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER +61   // X offset: -left  +right  [of the nozzle]
